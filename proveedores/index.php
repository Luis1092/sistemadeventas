                                    ...
                                    foreach ($proveedores_datos as $proveedores_dato) {
                                        ...
                                        <tr>
                                            ...
                                            <td>                                                
                                                    ...
                                                    <div class="modal fade" id="modal-update<?php echo $id_proveedor; ?>" aria-hidden="true" style="display: none;">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                    ...
                                                                                    <small style="color:red; display:none;" id="lbl_nombre_proveedor<?php echo $id_proveedor; ?>">* Este campo es requerido</small>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                    ...
                                                                                    <textarea class="form-control float-start" id="direccion<?php echo $id_proveedor; ?>"><?php echo $proveedores_dato['direccion'] ;?></textarea>                            
                                                    ...
                                                    <div class="modal fade" id="modal-delete<?php echo $id_proveedor; ?>" aria-hidden="true" style="display: none;">
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                    ...
                                                                                    <textarea class="form-control float-start" id="direccion<?php echo $id_proveedor; ?>" disabled><?php echo $proveedores_dato['direccion'] ;?></textarea>                            
                                                                                    <small style="color:red; display:none;" id="lbl_direccion<?php echo $id_proveedor; ?>">* Este campo es requerido</small>
                                                                            </div>
                                                                        </div>
                                                                    </div>
...
<div class="modal fade" id="modal-create" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #0c84ff; color:white">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                            ...
                            <small style="color:red; display:none;" id="lbl_nombre_proveedor">* Este campo es requerido</small>
                    </div>
                </div>
