...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Detalle de la venta Nro <?= $nro_venta ?> ¿Estás seguro de elimiar la venta?</h1>
                </div><!-- /.col -->
                    ...
                    <div class="card card-outline card-danger">
                        <div class="card-header">
                            <!-- Trae la cantidad de Venta -->
                             <h3 class="card-title"><i class="fa fa-shopping-bag"></i> Datos de la venta</h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?= $nit_ci_cliente;?>" class="form-control" disabled>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?= $email_cliente ?>" class="form-control" disabled>
                                    </div>
                                </div>
                            </div>                            
                        </div>
                ...
                <div class="col-md-3">
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body"> 
                            ...
                            <hr>
                            <div class="form-group">
                                <a href="<?= $URL?>/ventas" class="btn btn-secondary btn-block">Volver</a> 
                                <button id="btn_borrar_venta" type="submit" class="btn btn-danger btn-block">Borrar</button>                             
                            </div>
                            <script>
                                $('#btn_borrar_venta').click(function(){

                                    var id_venta = '<?= $id_venta_get; ?>';
                                    var nro_venta = '<?= $nro_venta_get; ?>';
