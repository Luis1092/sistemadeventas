                                      ...
                                      $id_compra = $compras_dato['id_compra']; ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="modal-producto<?php echo $id_compra; ?>" aria-hidden="true" style="display: none;">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-3">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input type="text" value="<?php echo $compras_dato['nombre_usuarios_productos']; ?>" class="form-control" disabled>
                                                                                        </div>
                                                                                    </div>
                                            ...
                                            <!-- Modal para visualizar productos -->
                                                <div class="modal fade" id="modal-proveedor<?php echo $id_compra; ?>" aria-hidden="true" style="display: none;">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <a href="https://wa.me/54<?php echo $compras_dato['celular_proveedor'];?>" target="_blank" class="btn btn-success">
                                            ...
                                            <td><?php echo $compras_dato['nombre_usuarios_productos']; ?></td>
                                            ...
                                            <td>
                                              <div class="modal-footer justify-content-between">
                                                <center>
                                                <div class="btn-group">
                                                  <a href="show.php?id=<?php echo $id_compra;?>" type="button" class="btn btn-info btn-sm"><i class="fa fa-eye"> Ver</i></a>
                                                  <a href="update.php?id=<?php echo $id_compra;?>" type="button" class="btn btn-success btn-sm"><i class="fa fa-pencil-alt"> Editar</i></a>
