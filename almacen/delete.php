  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0">Datos del producto: <?php echo $nombre;?> va a ser eliminado!</h1>
          </div><!-- /.col -->
                    ...
                    <form action="../app/controllers/almacen/delete.php" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-12">                            
                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="id_usuario" class="form-control" value="<?php echo $email; ?>" disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label for="">Descripción del producto:</label>
                                                    <textarea name="descripcion" id="" cols="30" rows="1" class="form-control" disabled>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <center>
                                                <img src="<?php echo $URL."almacen/img_productos/".$imagen;?>" width="60%" alt="">
                                            </center>                              
                                        </div>
                                    </div>
                                </div>
                                <hr>
                                <div class="form-group">
                                <a href="<?php echo $URL?>almacen/index.php" class="btn btn-secondary"> Volver</a>                       
                                <button type="submit" class="btn btn-danger"><i class="fa fa-trash"></i> Borrar producto</button>
                                </div>                            
                        </div>
                    </div>
                    </form>
