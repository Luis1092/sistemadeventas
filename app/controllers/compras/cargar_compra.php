...
pro.imagen as imagen, cat.nombre_categoria as nombre_categoria, us.nombres as nombre_usuarios_productos,
...
foreach($compras_datos as $compras_dato){
    ...
    $nombre_usuario = $compras_dato['nombre_usuarios_productos'];
    ...
    $telefono = $compras_dato['telefono_proveedor'];
    $empresa = $compras_dato['empresa'];
    $email_proveedor = $compras_dato['email_proveedor'];
    $direccion = $compras_dato['direccion_proveedor'];
